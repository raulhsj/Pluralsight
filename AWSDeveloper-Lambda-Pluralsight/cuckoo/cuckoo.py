...
FROM_ADDRESS = 'raulhsj@gmail.com'
REPLY_TO_ADDRESS = 'raulhsj@gmail.com'

CLIENTS = [
    {
        # You'll need to verify this email
        'email': 'usuariof869@gmail.com', 
        'first_name': 'Usuario',
        'last_name': 'Falso',
        'pet_name': 'Riley'
    },
...
TEMPLATE_S3_BUCKET = 'gpc-email-raulhsj-templates'
#
#
